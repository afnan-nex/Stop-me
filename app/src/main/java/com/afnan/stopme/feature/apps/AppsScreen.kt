...
fun AppsScreen(
    ...
    // Reset Countdown Dialog on Long Press
        ...
        AlertDialog(
            ...
            title = {
                Row(
                    ...
                    AppIconView(packageName = app.packageName, size = 36.dp)
                    Text(
            ...
            text = {
                Text(
                    text = "Reset today's usage countdown for ${app.label} back to full allowance?",
            ...
            confirmButton = {
                Button(
                    onClick = { viewModel.confirmResetCountdown() },
