...
### Changed
- **Developer Credits**: Updated about section text to "Developed by AFNAN with ❤️".
- **Notification Icon Optimization**: Increased optical glyph scale of the status bar notification icon for improved visibility and clarity across devices.
